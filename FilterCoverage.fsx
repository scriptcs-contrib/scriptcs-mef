...
doc.SelectNodes "//ModuleName[starts-with(., 'ℛ')]/.."
    ...
    |> ignore
System.IO.File.WriteAllLines(System.String.Concat(System.Environment.GetEnvironmentVariable("APPVEYOR_BUILD_FOLDER"), "filtered-coverage.xml"), doc.OuterXml.Split(' '))